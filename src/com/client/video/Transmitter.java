...
class AVTransmit2 {
	...
	static void prUsage() {
		System.err
				.println("Usage: AVTransmit2 <sourceURL> <destIP> <destPortBase>");
...
public class Transmitter {
	...
	public void start(Contact contact, String port)
	{
		this.port = port;
		...
		AVTransmit2 at = new AVTransmit2(ml, contact.getIP(), port, fmt);
		...
		System.out.println("donedef;piugopidfgupdfupigjdf;lig;lsfjdlgjlsdl");
		at.stop();
